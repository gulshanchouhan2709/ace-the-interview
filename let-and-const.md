...
* **Temporal Dead Zone** : Time since when the let variable was hoisted until it is initialized some value. 
    - So any line till before "let a = 10" is the TDZ
...
* Types of **Error**: Syntax, Reference, and Type.
    ...
    * Uncaught ReferenceError: x is not defined at ...
        * This Error signifies that x has never been in the scope of the program. This means that x was never defined/declared and is being tried to be accesed.
